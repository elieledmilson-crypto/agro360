...
export default function ExpensesPage() {
  ...
  const handleDelete = (id: string) => {
    ...
    if (window.confirm(`Excluir a despesa ${transaction.description}?`)) {
      try {
        ...
        <div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <HelpTip
              ...
              description="São saídas financeiras da propriedade, como custeio agrícola, ração, medicamentos, manutenção de máquinas e outros gastos."
            />
          </div>

          <p className="text-gray-600 dark:text-gray-400">
            Acompanhe as despesas da propriedade.
          </p>
        </div>

        <Button onClick={() => navigate('/financeiro/despesas/nova')}>
      ...
      {expenses.length === 0 ? (
        <div className="text-center py-12">
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">
            Registre a primeira despesa da propriedade.
          </p>
            ...
            {filtered.map(transaction => (
              <Card key={transaction.id} className="p-4">
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  ...
                  <Link
                    to={`/financeiro/despesas/${transaction.id}/editar`}
                    className="inline-flex items-center px-3 py-1.5 text-xs font-medium border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800"
                  >
                    Editar
                  </Link>
