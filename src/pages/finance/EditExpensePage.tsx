...
export default function EditExpensePage() {
  ...
  const handleSubmit = (
    ...
    try {
      ...
      navigate(`/financeiro/despesas/${updated.id}`, {
        state: {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <HelpTip
            ...
            description="Aqui você pode atualizar as informações desta despesa."
          />
        </div>
      ...
      <FinancialTransactionForm
        ...
        onCancel={() => navigate(`/financeiro/despesas/${transaction.id}`)}
